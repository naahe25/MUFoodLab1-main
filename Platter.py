...
class Platter_on:
    def __init__(self, root):
        self.root = root
        self.root.title("Platter On")
        self.root.geometry("915x440+190+80")

        #==============Title======================
        lbl_title = Label(self.root, text="Platter On", font=("times new roman", 20, "bold"), bg="black", fg="gold")
        ...
        # Text
        text_label1 = Label(self.custom_frame1, text="Platter 1", font=("times new roman", 15), bg="light grey")
        text_label1.pack(pady=2)

        # Another Text
        text_label2 = Label(self.custom_frame1, text="1800 BDT", font=("times new roman", 15), bg="light grey")
        ...
        # Text
        text_label3 = Label(self.custom_frame2, text="Platter 2", font=("times new roman", 15), bg="light grey")
        text_label3.pack(pady=2)

        # Another Text
        text_label4 = Label(self.custom_frame2, text="2000 BDT", font=("times new roman", 15), bg="light grey")
        ...
        # Text
        text_label5 = Label(self.custom_frame3, text="Platter 3", font=("times new roman", 15), bg="light grey")
        text_label5.pack(pady=2)

        # Another Text
        text_label6 = Label(self.custom_frame3, text="2200 BDT", font=("times new roman", 15), bg="light grey")
