...
class Drinks_on:
    def __init__(self, root):
        ...
        # Text
        text_label1 = Label(self.custom_frame1, text="Rossini", font=("times new roman", 15), bg="light grey")
        ...
        self.custom_frame2.place(x=320, y=50, width=235, height=300)

        img2 = Image.open(r"d2.jpeg")
        ...
        # Text
        text_label3 = Label(self.custom_frame2, text="Majo", font=("times new roman", 15), bg="light grey")
        text_label3.pack(pady=2)

        # Another Text
        text_label4 = Label(self.custom_frame2, text="60 BDT", font=("times new roman", 15), bg="light grey")
        ...
        # Text
        text_label5 = Label(self.custom_frame3, text="Sprite", font=("times new roman", 15), bg="light grey")
