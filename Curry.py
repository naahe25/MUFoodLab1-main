...
class Curry_on:
    def __init__(self, root):
        self.root = root
        self.root.title("Curry On")
        self.root.geometry("915x440+190+80")

        #==============Title======================
        lbl_title = Label(self.root, text="Curry On", font=("times new roman", 20, "bold"), bg="black", fg="gold")
        ...
        # Text
        text_label1 = Label(self.custom_frame1, text="Chicken With Dhal", font=("times new roman", 15), bg="light grey")
        text_label1.pack(pady=2)

        # Another Text
        text_label2 = Label(self.custom_frame1, text="300 BDT", font=("times new roman", 15), bg="light grey")
        ...
        # Text
        text_label3 = Label(self.custom_frame2, text="Kadai Chicken", font=("times new roman", 15), bg="light grey")
        text_label3.pack(pady=2)

        # Another Text
        text_label4 = Label(self.custom_frame2, text="350 BDT", font=("times new roman", 15), bg="light grey")
        ...
        # Text
        text_label5 = Label(self.custom_frame3, text="Rogan Josh", font=("times new roman", 15), bg="light grey")
        text_label5.pack(pady=2)

        # Another Text
        text_label6 = Label(self.custom_frame3, text="400 BDT", font=("times new roman", 15), bg="light grey")
