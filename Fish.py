...
class Fish_on:
    def __init__(self, root):
        ...
        # Text
        text_label1 = Label(self.custom_frame1, text="Riso e filetto ", font=("times new roman", 15), bg="light grey")
        text_label1.pack(pady=2)

        # Another Text
        text_label2 = Label(self.custom_frame1, text="400 BDT", font=("times new roman", 15), bg="light grey")
        ...
        # Text
        text_label3 = Label(self.custom_frame2, text="Razor Clams", font=("times new roman", 15), bg="light grey")
        text_label3.pack(pady=2)

        # Another Text
        text_label4 = Label(self.custom_frame2, text="450 BDT", font=("times new roman", 15), bg="light grey")
        ...
        # Text
        text_label5 = Label(self.custom_frame3, text="Lobster Dish", font=("times new roman", 15), bg="light grey")
        text_label5.pack(pady=2)

        # Another Text
        text_label6 = Label(self.custom_frame3, text="500 BDT", font=("times new roman", 15), bg="light grey")
