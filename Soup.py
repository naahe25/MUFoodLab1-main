...
class Soup_on:
    def __init__(self, root):
        ...
        # Text
        text_label1 = Label(self.custom_frame1, text="Wicked Thai ", font=("times new roman", 15), bg="light grey")
        ...
        # Text
        text_label3 = Label(self.custom_frame2, text="Thai Pork Ramen", font=("times new roman", 15), bg="light grey")
        ...
        # Text
        text_label5 = Label(self.custom_frame3, text="Tom Yum Soup", font=("times new roman", 15), bg="light grey")
